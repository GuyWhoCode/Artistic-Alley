...
export default function Page() {
    ...
    return (
        <main>
            <div className="flex flex-col items-center justify-center pt-[60px] min-w-[320px]">
                <h1 className="pb-4 text-5xl font-bold">Discovery page</h1>
                <Input className=" max-w-[480px] mb-3 " placeholder="Search" />
                <div className="grid grid-cols-2 gap-4 px-2">
                    <HomepageCommision imgSrc = "https://picsum.photos/200" userName ="User Name" price="Price $$$" title="Commision Title" profilePicture={pfpUrlPlaceholder}/>
                    <HomepageCommision imgSrc = "https://picsum.photos/200" userName ="User Name" price="Price $$$" title="Commision Title" profilePicture={pfpUrlPlaceholder}/>
                    <HomepageCommision imgSrc = "https://picsum.photos/200" userName ="User Name" price="Price $$$" title="Commision Title" profilePicture={pfpUrlPlaceholder}/>
                    <HomepageCommision imgSrc = "https://picsum.photos/200" userName ="User Name" price="Price $$$" title="Commision Title" profilePicture={pfpUrlPlaceholder}/>
                    <HomepageCommision imgSrc = "https://picsum.photos/200" userName ="User Name" price="Price $$$" title="Commision Title" profilePicture={pfpUrlPlaceholder}/>
